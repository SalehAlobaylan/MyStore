 import { Pipe, PipeTransform } from '@angular/core';
  ...
  export class FirstImagePipe implements PipeTransform {
    transform(imageUrls: string): string {
      if (!imageUrls) return 'https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/e6da41fa-1be4-4ce5-b89c-22be4f1f02d4/air-force-1-07-mens-shoes-jBrhbr.png';
